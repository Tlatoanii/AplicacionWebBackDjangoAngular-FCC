...
class MaestrosAll(generics.CreateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        maestros = Maestro.objects.filter(user__is_active = 1).order_by("id")
...
class MaestrosView(generics.CreateAPIView):
    ...
    # permission_classes = (permissions.IsAuthenticated,)
    def get(self, request, *args, **kwargs):
        maestro = get_object_or_404(Maestro, id = request.GET.get("id"))
    ...
    def post(self, request, *args, **kwargs):
        ...
        if user.is_valid():
            ...
            maestro = Maestro.objects.create(user=user,
...
class MaestrosViewEdit(generics.CreateAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        maestro = get_object_or_404(Maestro, id=request.data["id"])
        maestro.calve_maestro = request.data["clave_maestro"]
        ...
        maestro.materias = json.dumps(request.data["materias"])
        maestro.save()
        temp = maestro.user
    ...
    def delete(self, request, *args, **kwargs):
        admin = get_object_or_404(Maestro, id=request.GET.get("id"))
        try:
            admin.user.delete()
